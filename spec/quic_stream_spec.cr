...
describe QUIC::Stream do
  ...
  it "write is clamped to max_stream_data_remote (flow control)" do
    stream = QUIC::Stream.new(0_u64, 10_u64, 1_000_000_u64)
    n = stream.write(Bytes.new(20, 0_u8))
    n.should eq(10)
  end

  it "update_max_stream_data raises the remote credit and unblocks writes" do
    ...
    stream.write(Bytes.new(5, 1_u8))
    stream.poll_send_data(1000, 1_000_000_u64)  # advances tx_offset to 5
    stream.write(Bytes.new(1, 1_u8)).should eq(0)  # remote limit exhausted
    stream.update_max_stream_data(10_u64)
    stream.write(Bytes.new(5, 1_u8)).should eq(5)
  end
